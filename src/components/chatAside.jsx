...
import dp1 from "../images/ed.png"
import dp2 from "../images/no.jpg"
import dp3 from "../images/Camera man cry.png"
import dp4 from "../images/think.png"
                    ...
                    <div className="chat-list">
                        <div className="chat-box" id="msg1" onClick={handleChat}>
                            <div className="chat-img">
                                <img onClick={()=>window.open(icon)} src={icon} alt="show"/>
                            </div>
                        ...
                        <div className="chat-box" id="msg2">
                            <div className="chat-img">
                                <img onClick={()=>window.open(dp1)} src={dp1} alt="show"/>
                            </div>
                            <div className="chat-details">
                                <div className='chat-title'>
                                    <h3>Eddie</h3>
                        ...
                        <div className="chat-box" id="msg3">
                            <div className="chat-img">
                                <img src={dp2} onClick={()=>window.open(dp2)} alt="show"/>
                            </div>
                            <div className="chat-details">
                                <div className='chat-title'>
                                    <h3>Laura</h3>
                        ...
                        <div className="chat-box" id="msg4">
                            <div className="chat-img">
                                <img src={dp3} onClick={()=>window.open(dp3)} alt="show"/>
                            </div>
                            <div className="chat-details">
                                <div className='chat-title'>
                                    <h3>Daniel</h3>
                        ...
                        <div className="chat-box" id="msg5">
                            <div className="chat-img">
                                <img src={dp4} onClick={()=>window.open(dp4)} alt="show"/>
                            </div>
                            <div className="chat-details">
                                <div className='chat-title'>
                                    <h3>G7-groupChat</h3>
